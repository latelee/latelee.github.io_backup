...
下图是默认的lubuntu桌面：   
![](/assets/2018/04/p_lubuntu_org_desktop.png)
...
定制效果如下图所示：  
![](/assets/2018/04/p_background.png)
...
效果如下（红框部分所示）：  
英文界面：  
![](/assets/2018/04/p_bootlogo_en.png)  </br>
简体中文界面：  
![](/assets/2018/04/p_bootlogo_zh.png)  </br>
繁体中文界面：  
![](/assets/2018/04/p_bootlogo_tw.png)  </br>
...
![](/assets/2018/04/p_lxterminal.png)  </br>
...
![](/assets/2018/04/p_desktop_install.png)  </br>
...
```
效果如下：  
![](/assets/2018/04/p_desktop_icon.png)  </br>
...
效果如下图所示：  
![](/assets/2018/04/p_desktop_home.png)  </br>
...
```
效果图如下（左侧中文，右侧英文）：  
![](/assets/2018/04/p_startmenu_xlock.png)  </br>
...
![](/assets/2018/04/p_startmenu_pro.png) </br>
...
登陆效果图如下：  
![](/assets/2018/04/p_newuser_latelee.png) </br>
在此前提下，创建桌面快捷方式：  
...
输入法选择界面：  
![](/assets/2018/04/p_fcitx.png) </br>
五笔输入界面：  
![](/assets/2018/04/p_fcitx2.png) </br>
...
# 5、最终定制效果及ISO下载
定制效果图如下： 
![](/assets/2018/04/p_desktop_final.png) </br>
